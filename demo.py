...
def aggregate(str):
    ...
    if str[0] == 'M' and str[1] == 'I' and str[2] == 'N' and str[3] == '(':
        ...
        present = True
    elif str[0] == 'R' and str[1] == 'O' and str[2] == 'U' and str[3] == 'N' and str[4] == 'D' and str[5] == '(':
        present = True
    elif str[0:11] == 'FORMAT_DATE' or str[0:10] == 'DATE_TRUNC':
        present = True
    return present
    ...
    while ind < len(parsed):
        ...
        #From condition
            ...
            if parsed[ind + 1] == '(':
                ...
                str = 'FROM\n\n( ' 
                cte_table_name = ''
                while j < len(parsed) and parsed[j] != ')' and parsed[j].upper() != 'WHERE' and parsed[j].upper() != 'JOIN' and parsed[j].upper() != 'GROUP' and parsed[j].upper() != 'ORDER' and parsed[j].upper() != 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
        ...
        #Where condition
            ...
            isAfterAnd = False
            countAfterAnd = 0
            while j < len(parsed) and parsed[j].upper() != 'JOIN' and parsed[j].upper() != 'GROUP' and parsed[j].upper() != 'ORDER' and parsed[j].upper() != 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
                if parsed[j] == ')':
                    break
                if parsed[j] == '(':
                    if isAfterAnd == True:
        ...
        #Join condition
            ...
            for table_name in list_of_cte:
                if table_name.key_ele[6:] == cte_table_name:
                    list_of_cte_table.append(table_name)
                    break
            while j < len(parsed) and parsed[j] != ')' and parsed[j] != 'WHERE' and parsed[j].upper() != 'GROUP' and parsed[j].upper() != 'JOIN' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
        ...
        #group by condition
            ...
            j = ind + 2
            str = 'GROUP BY' + '\n\n( '
            while j < len(parsed) and parsed[j] != ')' and parsed[j].upper() != 'HAVING' and parsed[j].upper() != 'ORDER' and parsed[j].upper() != 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
                if parsed[j][len(parsed[j]) - 1] == ',':
                    str += parsed[j] + '\n'
                else:
                    str += parsed[j] + ' '
        ...
        #Having condition
            ...
            j = ind + 1
            str = 'HAVING' + '\n\n( '
            while j < len(parsed) and parsed[j] != ')' and parsed[j].upper() != 'ORDER' and parsed[j].upper() != 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
                if parsed[j][len(parsed[j]) - 1] == ',':
                    str += parsed[j] + '\n'
                else:
                    str += parsed[j] + ' '
        ...
        #Order by condition
            ...
            j = ind + 2
            str = 'ORDER BY' + '\n\n( '
            while j < len(parsed) and parsed[j] != ')' and parsed[j].upper() != 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
                if parsed[j][len(parsed[j]) - 1] == ',':
                    str += parsed[j] + '\n'
                else:
                    str += parsed[j] + ' '
        ...
        #LIMIT condition
        elif clause.upper() == 'LIMIT' and parsed[j].upper() != 'UNION' and parsed[j].upper() != 'WITHUNION' and parsed[j] != ')WITHEND' and parsed[j] != '),WITHEND':
            j = ind + 1
            str = 'LIMIT' + '\n\n( '
